...
This is a test project demostrating the use of the Globeport Elements UWP native host. Globeport is a new platform enabling rapid development of cross platform, interactive content, powered by XAML and Javascript. 
